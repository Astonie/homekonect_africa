<x-app-dashboard>
    ...
    <x-slot name="navigation">
        ...
        <div class="relative" x-data="{ propertyMenuOpen: true }">
            ...
            <div x-show="propertyMenuOpen && sidebarOpen" x-transition class="ml-11 mt-2 space-y-1">
                ...
                <a href="{{ route('landlord.properties.create') }}" class="block px-4 py-2 text-sm text-blue-400 font-semibold bg-gray-800 rounded-lg">Add New</a>
            </div>
        </div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-blue-600 font-medium">Add New Property</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('landlord.properties.store') }}" method="POST" enctype="multipart/form-data" x-data="{ submitting: false }" @submit="submitting = true">
                @csrf
