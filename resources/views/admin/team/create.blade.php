            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-indigo-600 font-medium">Add New</span>
                    </div>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="text-xs text-gray-500 mt-1">JPG, PNG, GIF (Max 2MB). If not uploaded, a placeholder will be used.</p>
                                @error('photo')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
