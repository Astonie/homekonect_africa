        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-gray-900 text-white flex-shrink-0 transition-all duration-300 ease-in-out">
            <div class="p-6">
                ...
                <div class="flex items-center space-x-3 mb-8" x-show="sidebarOpen" x-transition>
                    <div class="w-10 h-10 bg-gradient-to-br from-purple-500 to-blue-700 rounded-lg flex items-center justify-center shadow-lg">
                        <span class="text-white font-bold text-xl">A</span>
                    </div>
                    <div>
                        <div class="text-lg font-bold">HomeKonnect</div>
                        <div class="text-xs text-gray-400">Admin Control Panel</div>
                    </div>
                </div>
                ...
                <!-- Navigation -->
                <nav class="space-y-2">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 bg-gray-800 rounded-lg text-blue-400 transition-all duration-200 hover:bg-gray-700 transform hover:scale-105" :class="!sidebarOpen && 'justify-center'" x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false">
                    ...
                    <div class="relative">
                        ...
                        <div x-show="propertyMenuOpen && sidebarOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" class="ml-11 mt-2 space-y-1">
                            <a href="{{ route('admin.properties.index') }}" class="block px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition transform hover:translate-x-1">All Properties</a>
                            <a href="{{ route('admin.properties.create') }}" class="block px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition transform hover:translate-x-1">Add New</a>
                        </div>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50 px-8 py-6">
                ...
                <div class="mb-8 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Welcome back, {{ Auth::user()->name }}! Monitor and manage your platform.</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-sm p-6 border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer group">
                        ...
                        <div class="text-3xl font-bold text-gray-900" x-data="{ count: 0, target: {{ $stats['total_properties'] ?? 0 }} }" x-init="setInterval(() => { if(count < target) count++ }, 50)">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 mb-8 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('admin.properties.create') }}" class="flex items-center justify-center space-x-3 bg-blue-600 text-white px-6 py-4 rounded-lg hover:bg-blue-700 transition shadow-md hover:shadow-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
