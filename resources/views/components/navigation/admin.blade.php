...
<a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 {{ $active === 'dashboard' ? 'bg-gray-800 text-purple-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
...
<a href="{{ route('admin.site-settings.index') }}" class="flex items-center px-4 py-3 {{ $active === 'settings' ? 'bg-gray-800 text-purple-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <span x-show="sidebarOpen" x-transition x-cloak class="font-medium">Site Settings</span>
</a>

<a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 {{ $active === 'profile' ? 'bg-gray-800 text-purple-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
