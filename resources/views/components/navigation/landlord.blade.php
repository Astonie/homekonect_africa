...
<div class="relative" x-data="{ propertyMenuOpen: {{ $active === 'properties' ? 'true' : 'false' }} }">
    <button @click="propertyMenuOpen = !propertyMenuOpen" class="w-full flex items-center px-4 py-3 {{ $active === 'properties' ? 'bg-gray-800 text-blue-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'justify-between space-x-3' : 'justify-center'">
...
<!-- Documents -->
<a href="{{ route('landlord.documents.index') }}" class="flex items-center px-4 py-3 {{ $active === 'documents' ? 'bg-gray-800 text-blue-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Messages -->
<a href="{{ route('messages.index') }}" class="relative flex items-center px-4 py-3 {{ $active === 'messages' ? 'bg-gray-800 text-blue-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Settings -->
<a href="{{ route('settings.index') }}" class="flex items-center px-4 py-3 {{ $active === 'settings' ? 'bg-gray-800 text-blue-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
