...
<a href="{{ route('messages.index') }}" class="relative flex items-center px-4 py-3 {{ $active === 'messages' ? 'bg-gray-800 text-green-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} rounded-lg transition-all duration-200 transform hover:scale-105" :class="sidebarOpen ? 'space-x-3' : 'justify-center'">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
