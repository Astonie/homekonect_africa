...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 transition-colors duration-300" x-data="{ mobileMenuOpen: false, scrolled: false }" 
    ...
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 dark:from-gray-950 dark:via-blue-950 dark:to-gray-950 min-h-screen flex items-center overflow-hidden">
        ...
        <!-- Gradient Overlays -->
        <div class="absolute inset-0 bg-gradient-to-b from-transparent via-blue-900/20 to-gray-900/90"></div>
