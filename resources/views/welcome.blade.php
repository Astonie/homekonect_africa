...
@section('content')
    ...
    <section id="properties" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('home') }}" class="grid md:grid-cols-5 gap-4 items-end mb-8">
                <!-- Location Input -->
                <div class="space-y-2">
                    ...
                    <input type="text" name="location" placeholder="Enter city, state, or zip code"
