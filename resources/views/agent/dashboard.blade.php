<x-app-dashboard 
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-blue-900/20 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['active_clients'] ?? 0 }}</div>
        </div>
        ...
        <div class="bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-green-900/20 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['properties_listed'] ?? 0 }}</div>
        </div>
        ...
        <div class="bg-gradient-to-br from-white to-purple-50 dark:from-gray-800 dark:to-purple-900/20 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
            ...
            <div class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['deals_closed'] ?? 0 }}</div>
        </div>
        ...
        <div class="bg-gradient-to-br from-white to-yellow-50 dark:from-gray-800 dark:to-yellow-900/20 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Clients</div>
            <div class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['total_clients'] ?? 0 }}</div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-8 border border-gray-200 dark:border-gray-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('agent.clients.create') }}" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition group">
            ...
            <a href="{{ route('agent.clients.index') }}" class="flex items-center p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition group">
                ...
                <div>
                    <p class="font-semibold text-gray-900 dark:text-white">My Clients</p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Manage clients</p>
                </div>
            </a>
        </div>
    </div>
