    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('agent.properties.index') }}" class="text-gray-600 hover:text-gray-900">
                    ← Back to Properties
                </a>
            </div>
        </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    @foreach($property->images as $image)
                                        ...
                                        @endphp
                                        <div class="relative">
                                            <img src="{{ $imagePath }}" alt="{{ $property->title }}" class="w-full h-48 object-cover rounded-lg {{ $isFeatured ? 'ring-4 ring-orange-500' : '' }}">
                                            @if($isFeatured)
